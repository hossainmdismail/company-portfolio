                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        @foreach ($testimonials as $testimonial)
                            <tr>
                                <td><img width="50" src="{{ asset('uploads/testimonial') }}/{{ $testimonial->profile }}">
                                </td>
                                <td>{{ $testimonial->name }}</td>
                                <td>{{ $testimonial->title }}</td>
                                <td>{{ $testimonial->field }}</td>
                                <td class="d-flex align-items-center"><i
                                        class="fa fa-circle text-{{ $testimonial->status != 2 ? 'success' : 'warning' }} mr-1"></i>{{ $testimonial->status != 2 ? 'Active' : 'Deactive' }}
                                </td>
                                <td>
                                    <div class="d-flex">
