                ...
                <div class="">
                    ...
                    <div class="pt-3 flex flex-col justify-center items-center lg:items-start gap-3 md:gap-3 lg:gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <a href="https://wa.me/message/PYAMSLHROXKKB1" target="_blank"
                                class="font-semibold">+8801613408101</a>
                        </div>
                        <div class="flex items-center gap-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <a href="mailto:office@synexdigital.com" class="font-semibold">office@synexdigital.com</a>
                        </div>
